...
$faqs = [
    [
        ...
        'content' => [
            ...
            potremmo non essere nella posizione giusta per prendere decisioni in merito al tuo caso. Se non sei d\'accordo con la nostra valutazione, puoi rivolgerti all\'
            Autorità garante per la protezione dei dati personali nel tuo paese.',
    ...
    [
        ...
        'content' => [
            ...
            <a href="#">fai clic qui</a>. Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l\'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. 
    ...
    [
        ...
        'content' => [
            'In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google,
             ...
             della pagina dei risultati di ricerca sotto forma di <a href="#">URL referrer</a>. Talvolta, l\'URL della pagina dei risultati di ricerca potrebbe contenere la query di ricerca che hai inserito.
